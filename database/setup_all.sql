-- ==========================================================
-- ZIVO — full database setup (schema + seed data)
-- Run this ONE file against a fresh, empty zivo_db database.
-- ==========================================================
...
-- ---- schema/04_create_categories.sql ----
USE zivo_db;
...
-- ---- schema/05_create_subcategories.sql ----
USE zivo_db;
...
-- ---- schema/08_create_product_images.sql ----
USE zivo_db;
...
-- ---- schema/09_create_inventory.sql ----
USE zivo_db;
...
-- ---- schema/11_create_cart_items.sql ----
USE zivo_db;
...
('Toys & Games','Kids toys and games'),
...
('Health & Wellness','Healthcare products'),
('Baby Products','Baby care essentials'),
('Jewellery','Gold, silver and fashion jewellery'),
('Watches','Analog and smart watches'),
('Luggage & Travel','Travel bags and suitcases'),
('Furniture','Home and office furniture'),
('Garden & Outdoor','Garden and outdoor equipment'),
('Musical Instruments','Musical instruments and accessories'),
('Industrial & Scientific','Industrial and laboratory products');

-- ---- seed/04_seed_subcategories.sql ----
...
-- ---- seed/05_seed_brands.sql ----
USE zivo_db;

INSERT INTO brands
(brand_name)
VALUES
('Apple'),('Samsung'),('Sony'),('LG'),('Dell'),('HP'),('Lenovo'),('Asus'),('Acer'),('MSI'),('Nike'),('Adidas'),('Puma'),
('Reebok'),('Levis'),('Zara'),('H&M'),('Boat'),('OnePlus'),('Realme'),('Xiaomi'),('Oppo'),('Vivo'),('Canon'),('Nikon'),
('Bajaj'),('Philips'),('Prestige'),('Tata'),('Amul'),('Microsoft'),('Razer'),('Noise'),('Fitbit'),('JBL'),('Bose'),('Marshall'),
('Epson'),('Brother'),('Logitech'),('Corsair'),('Nintendo'),('TP-Link'),('Anker'),('Ambrane'),('Stuffcool'),('Seagate'),
('Western Digital'),('Netgear'),('Cisco'),('Kingston'),('D-Link'),('Tenda'),('Wipro'),('Syska'),('Amazon'),('Google'),('Bata'),('Skechers'),
('Wildcraft'),('American Tourister'),('Samsonite'),('Fastrack'),('Titan'),('Fossil'),('Casio'),('Tanishq'),('CaratLane'),('Ray-Ban'),
('Lenskart'),('IKEA'),('Godrej'),('Havells'),('Nilkamal'),('Durian'),('Sleepwell'),('Urban Ladder'),('Pepperfry'),('Milton'),('Hawkins'),
('Borosil'),('Home Centre'),('Harpic'),('Lizol'),('Scotch-Brite'),('Vim'),('Mother Dairy'),('Nestle'),('Britannia'),('Parle'),
('Pepsi'),('Coca Cola'),('Tata Consumer Products'),('Fresh Farm'),('Decathlon'),('Cosco'),('Reebok Fitness'),('Boldfit'),('HealthKart'),
('Yonex'),('Spalding'),('Cultsport'),('Lifelong'),('Aurion'),('Nivia'),('Hero'),('Speedo'),('Lakme'),('L\'Oreal'),('Dove'),('Nivea'),
('Garnier'),('Maybelline'),('Gillette'),('Pedigree'),('Himalaya'),('Johnson & Johnson'),('Fisher Price'),('Mattel'),('Funskool'),
('Hot Wheels'),('Yamaha'),('Fender'),('Bosch'),('Hindware'),('Cera'),('India Gate'),('Fortune'),('Daawat'),('Biba'),('Manyavar'),
('Fabindia'),('W for Woman'),('Stanley'),('Fevicol'),('Asian Paints'),('NCERT'),('Oxford'),('Pearson'),('Cambridge'),('EduKart'),('Oswaal'),
('Arihant'),('Scholastic'),('Universal'),('Penguin'),('HarperCollins'),('Marvel'),('DC Comics'),('Patanjali'),('Colgate'),('Dettol'),
('Savlon'),('Revlon'),('Nail Art Pro'),('ManiCare'),('DermaTools'),('GroomWell'),('RC Pro Toys'),('DroneX'),('Mega Blocks'),('Barbie'),
('Disney Toys'),('Puzzle World'),('Outdoor Fun'),('LeapFrog');

-- ---- seed/06_seed_products.sql ----
USE zivo_db;
...
-- ---- seed/07_seed_product_images.sql ----
USE zivo_db;
...
-- ---- seed/09_seed_cart.sql ----


-- ---- seed/10_seed_cart_items.sql ----


-- ---- seed/11_seed_category_subcategory_images.sql ----
USE zivo_db;
